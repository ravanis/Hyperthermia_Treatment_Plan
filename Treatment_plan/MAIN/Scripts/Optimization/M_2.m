...
% Function that calculates M2 and converts the polynomial M2 solver arguments
% X to complex amplitudes and applies them to the total Efield.
% ------INPUTS--------------------------------------------------------------
% X:                   Solver argument vector to minimized polynomial M2. 
...
largest = 0;
    ...
    y = M2(abs_sq(E_opt_sum),tumor_oct, healthy_tissue_oct);
